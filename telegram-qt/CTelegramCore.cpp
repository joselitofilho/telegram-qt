    ...
    m_appInfo(0)
{
    ...
    connect(m_dispatcher, SIGNAL(sentMessageStatusChanged(quint32,TelegramNamespace::MessageDeliveryStatus,QString)),
            SIGNAL(sentMessageStatusChanged(quint32,TelegramNamespace::MessageDeliveryStatus,QString)));
